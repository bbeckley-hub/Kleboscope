...
class KleboHTMLGenerator:
    ...
    def generate_main_report(self, integrated_data: Dict, output_dir: Path) -> str:
        ...
        output_file = output_dir / "kleboscope_ultimate_gene_centric_report.html"
...
"""
    ...
    def _generate_export_section(self, data: Dict) -> str:
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px;margin:15px 0;">
            ...
            <div class="dashboard-card" onclick="window.location.href='kleboscope_ultimate_gene_centric_report.json'"><i class="fas fa-file-code fa-2x"></i><div>Complete JSON</div></div>
        </div>
        """
...
class KleboscopeUltimateReporter:
    def __init__(self, input_dir: Path):
        ...
        self.output_dir = self.input_dir / "KLEBOSCOPE_ULTIMATE_GENE_CENTRIC_REPORTS"
    ...
    def integrate_all_data(self, html_files: Dict) -> Dict:
        ...
        if not mutation_html.exists():
            mutation_html = self.input_dir / "klebo_amrfinder_results" / "mutation_summary.html"
    ...
    def generate_json_report(self, integrated: Dict) -> Path:
        out = self.output_dir / "kleboscope_ultimate_gene_centric_report.json"
    ...
    def run(self):
        ...
        print("📄 Open kleboscope_ultimate_gene_centric_report.html in your browser.")
        return True
